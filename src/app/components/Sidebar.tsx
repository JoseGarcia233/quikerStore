...
const  MenuItms = [
  ...
  },
  {
    ...
    title:'Counter',
    subTtile: 'The Counter Client Side',
  },
  {
    path:'/dashboard/itemshop',
    icon:<RiShoppingBag2Fill size={40} />,
    title:'Items',
    subTtile: 'Shop Items',
  },
]
        ...
        <div id="menu"
            ...
            <div id="logo" className="my-4 px-6">
                <h1 className="  flex items-center text-lg md:text-2xl font-bold text-white">
                    ...
                    <span>Dash</span>
                    <span className="text-blue-500">8
                    </span>.
                </h1>
            ...
            <div id="nav" className="w-full px-6">
              {
                ...
                {/* <a href="#" className="w-full px-2 inline-flex space-x-2 items-center border-b border-slate-700 py-3 hover:bg-white/5 transition ease-linear duration-150">
                    ...
                    <div className="flex flex-col">
                        <span className="text-lg text-slate-300 font-bold leading-5">El count</span>
